...
#define  	SDI        		p3_7    // si4463 SPI control
#define  	nSEL			p1_3	// si4463 SPI control
#define  	SCK			p1_6	// si4463 SPI control
#define  	nIRQ       		p1_7	// Si4463 interrupt control
#define  	SDN	        	p4_5    // si4463 power on/down control
#define  	SDO	        	p4_6	// si4463 SPI control

#define  	LED_GREEN		p1_4  //LED indicator for data received
#define  	LED_RED			p1_5  //LED indicator for data transmitted	
...
{	
    ...
    spi_write(0x05, RF_MODEM_AGC_CONTROL_1_data);	// fixed, from WDS
